    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="masonry-item">
            ...
            <div class="form-group row"><label class="col-sm-3 col-form-label">担当工程</label>
              <div class="col-sm-9 input_item" name="feature_offer_point" class="form-control" id="feature_offer_point">
                @foreach ($responsible_process as $key => $values)
                  <label style="padding: .18rem .18rem;"><input id="responsible_process{{$key}}" type="checkbox" name="responsible_process[]" value={{$key}}>&nbsp;{{$values}}</label>
                @endforeach
              </div>
            </div>
