        ...
        <div class="masonry-item">
            ...
            <div class="form-group row"><label for="selection_flow" class="col-sm-3 col-form-label">選考フロー&nbsp;<span class="text-danger required">*</span></label>
              <div class="col-sm-9" name="selection_flow" class="form-control" id="selection_flow">
                @foreach ($selection_flows as $selection_flow => $values)
                  <div style="display:block;"><label style="padding: .18rem .18rem;"><input id="selection_flow_{{$selection_flow}}" type="checkbox" name="selection_flow[]" value={{$selection_flow}} onclick="click_cb();">&nbsp;{{$values}}</label></div>
                @endforeach
              </div>
            </div>
