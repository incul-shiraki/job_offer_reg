@extends('layouts.app')
@if ($status == 1)
  @section('title', '新規人材紹介求人情報の作成')
@elseif ($status  == 2)
  @section('title', '人材紹介求人情報の編集')
@endif
@section('header')
...
<main class="main-content bgc-grey-100">
  <div id="mainContent">
  <!-- コピーから作成 -->
  @include('/offer_comp/recruitment/create_from_copy')

  <!-- 募集企業 -->
  @include('/offer_comp/recruitment/company_info')

  <!-- 募集期間 -->
  @include('/offer_comp/recruitment/recruiting_period')

  <!-- 募集概要 -->
  @include('/offer_comp/recruitment/recruiting_overview')

  <!-- 勤務地 -->
  @include('/offer_comp/recruitment/working_place')

  <!-- 仕事内容 -->
  @include('/offer_comp/recruitment/job_content')

  <!-- 必須要件 -->
  @include('/offer_comp/recruitment/required_requirement')

  <!-- 募集要項 -->
  @include('/offer_comp/recruitment/offering_essential_point')

  <!-- 給与・待遇・福利厚生 -->
  @include('/offer_comp/recruitment/treatment')

  <!-- エージェント限定情報-->
  @include('/offer_comp/recruitment/agent_limited')
...
<!-- 新規募集企業登録 -->
  @include('/offer_comp/recruitment/recruit_company_register')

<!-- 募集企業更新 -->
  @include('/offer_comp/recruitment/recruit_company_update')
